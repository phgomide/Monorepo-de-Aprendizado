...
Dividi o aprendizado em módulos práticos para facilitar a navegação:

```text
.
├── 1 Condicionais e Loops/      # Controle de fluxo, validações e repetições
│
├── 2 Funcoes/                   # Modularização, parâmetros e retorno (em andamento)
│
